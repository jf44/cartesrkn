...
// en supprimant le chemin $dest_path
        // DEBUG
        //echo "<br />DEBUG :: zip.php :: 24 :: DEST_PATH='$dest_path', ZIP_NAME='$zip_name'\n<pre>\n";
...
// ----------------
function renommer_fichier_zip($zip_name, $ext_new){
	if (is_file($zip_name)){
		$path=dirname($zip_name);
		$nf=basename($zip_name);
		$nom_strict=nom_fichier($nf);
		// DEBUG
		//echo "<br>DEBUG :: zip.php :: 79 :: Path : $path ;  Nomfichier : $nf ; Nom strict : $nom_strict\n";
...
// ----------------
function supprime_dossier_vide($dossier){
	// DEBUG
